local MineLayerConfig = {
	...
	defaultBossEnemy = "Giant Slime",
	checkpointInterval = 5,
	-- Normal enemy spawn pools are configured per layer with enemies = { "" }.
	...
	[1] = {
        ...
        bossEnemy = "Giant Slime", -- Override default boss enemy for this layer
	},
	[2] = {
		name = "Copper Caves",
		theme = "copper_caves",
